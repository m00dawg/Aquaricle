...
DATABASES = {
    'default': {
        ...
        'NAME': 'aquaricle',                      # Or path to database file if using sqlite3.
        'USER': 'aquaricle',                      # Not used with sqlite3.
...
SECRET_KEY = 'ow@p*b3n@73x&amp;(7s31a$_z6ti)x^9m6s(fpc4y*l45-8ugue$z'
